...
import PageAccueil from '../../features/home/pages/PageAccueil';
...
import PageCreerReservation from '../../features/reservations/pages/PageCreerReservation';
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: '/reservations/creer', element: <PageCreerReservation /> },
          {
